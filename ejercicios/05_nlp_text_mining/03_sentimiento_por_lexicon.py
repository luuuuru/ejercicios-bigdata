...
# Se recomienda al alumno consultar los siguientes recursos para profundizar:
#
# 1. PROCESAMIENTO DE TEXTO (RE):
#    - Documentación Oficial Python (re): https://docs.python.org/3/library/re.html
#    - Guía de Linderos de Palabra (\b): https://learn.microsoft.com/es-es/dotnet/standard/base-types/word-boundaries
#
# 2. VISUALIZACIÓN (MATPLOTLIB):
#    - Documentación pyplot.pie: https://matplotlib.org/stable/api/_as_gen/matplotlib.pyplot.pie.html
#    - Guía de Estilos y Colores: https://matplotlib.org/stable/gallery/color/named_colors.html
#
# 3. REFERENCIAS ACADÉMICAS:
#    - Bird, S., Klein, E., & Loper, E. (2009). Natural Language Processing with Python. O'Reilly Media.
#      (Capítulo 1: Language Processing and Python).
#    - Hutto, C. J., & Gilbert, E. (2014). VADER: A Parsimonious Rule-based Model for
#      Sentiment Analysis of Social Media Text. Proceedings of the ICWSM.
#    - Saravia, E., et al. (2017). Sentiment Analysis on Spanish Twitter.
#      Journal of Information Science and Engineering.
#
# 4. LÉXICOS EN ESPAÑOL:
