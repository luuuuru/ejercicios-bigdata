...
Ejemplo: ¿La dependencia de recursos naturales afecta el acceso a servicios básicos
         en países en desarrollo (2000-2020)?
```
...
```bash
cd entregas/02_limpieza_datos/grupo_02/
...
# Commit inicial
git add .
git commit -m "GRUPO-02: Estructura inicial del proyecto"
...
git checkout -b grupo02-extract-pedro
# o
git checkout -b grupo02-transform-lucia
...
git commit -m "GRUPO-02: Implementar extract.py (Pedro Sánchez)
...
# 5. Push a tu rama
git push origin grupo02-extract-pedro
...
**Estructura:**
```
GRUPO-02: [Componente] Descripción breve (Autor)
...
**Ejemplos:**
```
GRUPO-02: Implementar fase Extract (Pedro Sánchez)
GRUPO-02: Crear schema PostgreSQL (Lucía Martín)
GRUPO-02: Añadir validaciones Transform (Miguel Ruiz)
GRUPO-02: Documentar metodología (Elena Torres)
```
...
git add .
git commit -m "GRUPO-02: Resolver conflictos merge (Tu Nombre)"
...
```bash
# Pipeline completo
python scripts/run_etl.py --tema 2 --year-start 2000 --year-end 2020
